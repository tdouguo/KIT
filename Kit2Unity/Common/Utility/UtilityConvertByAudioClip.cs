...
namespace Kit
{
    public static partial class Utility
    {
        ...
        /// 
        /// </summary> 
        public static class ConvertByAudioClip
        {
            ...
            public static byte[] FromAudioClip(AudioClip audioClip, out string filepath, bool saveAsFile = true, string dirname = "recordings")
            {
                ...
                if (saveAsFile)
                {
                    filepath = Utility.Text.Format("{0}/{1}/{2}.{3}", Application.streamingAssetsPath, dirname, DateTime.UtcNow.ToString("yyMMdd-HHmmss-fff"), "wav");
